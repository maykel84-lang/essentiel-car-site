/* =========================================================
   ESSENTIEL CAR — Internationalisation (FR / EN)
   ========================================================= */
...
function applyTranslations() {
  ...
  if (titleEl) document.title = currentLang === 'en' ? 'ESSENTIEL CAR — Premium Auto Equipment' : 'ESSENTIEL CAR — L\'équipement auto premium';
}
